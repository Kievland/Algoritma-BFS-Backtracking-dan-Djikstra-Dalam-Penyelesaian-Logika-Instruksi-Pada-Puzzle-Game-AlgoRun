...
int main() {
    ...
    vector<vector<int>> map2 = {
        {2, 0, 8, 4}, // Start, Jalan, Bola, Portal Masuk
        {1, 1, 1, 1}, // Jalan, Kosong, Kosong, Jalan
        {1, 1, 1, 1}, // Jalan, Kosong, Kosong, Jalan
        {5, 0, 8, 3}  // Portal Keluar, Jalan, Bola, Goal
    };

    GameState stateMap2;
    stateMap2.x = 0; stateMap2.y = 0; stateMap2.dir = 1; 
    stateMap2.orbs_collected = 0;
    stateMap2.total_orbs = 2; 
    stateMap2.grid = map2;
    stateMap2.step_limit = 50;

    cout << "=== EKSPERIMEN MAP 2: PORTAL (Max 6 Langkah) ===" << endl;
    solveBFS(stateMap2, 6);
    solveBacktracking(stateMap2, 6); 
    solveDijkstra(stateMap2, 6);    
